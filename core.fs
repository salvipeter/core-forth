...
: LOOP R> R>
       ...
       LIT@ ?BRANCH , HERE @ - , LIT@ 2DROP , ; IMMEDIATE
: +LOOP R> R>
...
: CASE 0 ; IMMEDIATE
: OF LIT@ OVER , LIT@ = , LIT@ ?BRANCH , HERE @ 0 , LIT@ DROP , ; IMMEDIATE
: ENDOF LIT@ BRANCH , HERE @ 0 , SWAP DUP HERE @ SWAP - SWAP ! SWAP 1+ ; IMMEDIATE
: ENDCASE LIT@ DROP , 0 ?DO DUP HERE @ SWAP - SWAP ! LOOP ; IMMEDIATE
