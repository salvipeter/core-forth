...
: IF LITERAL ?BRANCH , HERE @ 0 , ; IMMEDIATE
: ELSE LITERAL BRANCH , HERE @ 0 , SWAP DUP HERE @ SWAP - SWAP ! ; IMMEDIATE
: THEN DUP HERE @ SWAP - SWAP ! ; IMMEDIATE
: BEGIN HERE @ ; IMMEDIATE
: AGAIN LITERAL BRANCH , HERE @ - , ; IMMEDIATE
: UNTIL LITERAL ?BRANCH , HERE @ - , ; IMMEDIATE
: WHILE LITERAL ?BRANCH , HERE @ 0 , SWAP ; IMMEDIATE
: REPEAT LITERAL BRANCH , HERE @ - , DUP HERE @ SWAP - SWAP ! ; IMMEDIATE
: DO HERE @ LITERAL >R , LITERAL >R , ; IMMEDIATE
: LOOP LITERAL R> , LITERAL R> , LITERAL 1+ , LITERAL 2DUP ,
       LITERAL = , LITERAL ?BRANCH , HERE @ - , LITERAL 2DROP , ; IMMEDIATE
: +LOOP LITERAL R> , LITERAL R> , LITERAL ROT , LITERAL + ,
        LITERAL 2DUP , LITERAL > , LITERAL INVERT , LITERAL ?BRANCH ,
        HERE @ - , LITERAL 2DROP , ; IMMEDIATE
...
: CREATE : LITERAL LITERAL , HERE @ 2 CELLS + , LITERAL EXIT , REVEAL 0 STATE !
: ALLOT HERE @ + HERE ! ;
: VARIABLE CREATE 0 , ;
...
: ." [CHAR] " PARSE STATE @ IF
       LITERAL LITSTRING , DUP , 0 DO DUP C@ C, 1+ LOOP DROP LITERAL TYPE ,
     ELSE
       TYPE
     THEN ; IMMEDIATE
