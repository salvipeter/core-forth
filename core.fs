...
: WHILE LITERAL ?BRANCH , HERE @ 0 , ; IMMEDIATE
: REPEAT SWAP LITERAL BRANCH , HERE @ - , DUP HERE @ SWAP - SWAP ! ; IMMEDIATE
: UNTIL LITERAL ?BRANCH , HERE @ - , ; IMMEDIATE
: DO HERE @ LITERAL >R , LITERAL >R , ; IMMEDIATE
: LOOP LITERAL R> , LITERAL R> , LITERAL LITERAL , 1 , LITERAL + , LITERAL 2DUP ,
       LITERAL = , LITERAL ?BRANCH , HERE @ - , LITERAL 2DROP , ; IMMEDIATE
: +LOOP LITERAL R> , LITERAL R> , LITERAL LITERAL , , LITERAL + , LITERAL 2DUP ,
        LITERAL = , LITERAL ?BRANCH , HERE @ - , LITERAL 2DROP , ; IMMEDIATE
: I R> R@ >R ;
: J R> R> R@ SWAP >R SWAP >R ;

: CREATE : LITERAL LIT , HERE @ 2 CELLS + , LITERAL EXIT , REVEAL 0 STATE !
: ALLOT HERE @ + HERE ! ;
: VARIABLE CREATE 0 , ;
